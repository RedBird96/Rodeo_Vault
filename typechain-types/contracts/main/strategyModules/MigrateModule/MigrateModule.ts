...
export interface MigrateModuleInterface extends utils.Interface {
  functions: {
...
export interface MigrateModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MigrateModuleInterface;
  ...
  functions: {
    ...
    receiveFlashLoan(
      _loanTokens: PromiseOrValue<string>[],
      _loanAmounts: PromiseOrValue<BigNumberish>[],
