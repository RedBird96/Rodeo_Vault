...
export interface VaultV2Interface extends utils.Interface {
  functions: {
    ...
    "deleverageWithdraw(address,uint256,uint256,bytes,uint256,address,address)": FunctionFragment;
  ...
  events: {
    ...
    "DeleverageWithdraw(address,address,address,uint256,uint256)": EventFragment;
...
export interface VaultV2 extends BaseContract {
  ...
  functions: {
    ...
    deleverageWithdraw(
      ...
      _wethdebit: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    ...
    "DeleverageWithdraw(address,address,address,uint256,uint256)"(
      owner?: null,
      receiver?: null,
      token?: null,
      assetsGet?: null,
